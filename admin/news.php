...
<?php 
    ...
    $sql_action = "SELECT * FROM news WHERE id = $id";
            ...
            <div class="list-group">
              ...
              <a href="p_purpose.php" class="list-group-item list-group-item-action"> Payment Purpose </a>            
               ...
               <?php if(isset($_GET['del'])): ?>
                  <div class="alert alert-light alert-dismissible fade show" role="alert">
                    ...
                    <h4 class="alert-heading text-center"> DELETE <?php echo $action['title']; ?> </h4>
                    <hr/>
                    <p> <strong> ARE YOU SURE ? </strong></p>
                    <hr/>

                    <a href="action.php?del_news=<?php echo $action['id']; ?>" class=" btn btn-success alert-link"> CONFIRM </a>.
                 </div>
              <?php endif; ?>
              ...
              <?php if(isset($_GET['edit'])): ?>
                  <div class="alert alert-light alert-dismissible fade show" role="alert">
                    ...
                    <h4 class="alert-heading text-center"> EDIT <?php echo $action['title']; ?> </h4>
                    <hr/>
                   
                        <form method="post" action="action.php">
                          <div class="form-group">
                            <label for="p-purpose" class="form-control-label">title</label>
                            <input type="text" name="title" class="form-control" value="<?php echo htmlspecialchars($action['title']); ?>" required>
                          </div>

                          <div class="form-group"> 
                            <label for="p-amount" class="form-control-label">Content</label>
                            <textarea name="content" class="form-control"><?php echo htmlentities($action['content']); ?></textarea>
                          </div>
                          ...
                          <div class="modal-footer">
                            ...
                            <button type="submit" name="edit_news" class="btn btn-primary"> Edit </button>
                          </div>
                       </form>
                  </div>
              <?php endif; ?>
                    ...
                    <div class='card-body py-3 px-3 '>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                  <a href="news.php?edit=<?php echo $result['id']; ?>" class="btn bg-light text-dark mb-1">Edit</a>
                                  <a href="news.php?del=<?php echo $result['id']; ?>" class="btn btn-danger">Delete</a> 
                                </td>
                            </tr>
                          <?php endwhile; ?>
                        </table>
